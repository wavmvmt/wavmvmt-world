...
function ParkourGymInterior({ buildPct }: { buildPct: number }) {
  ...
  const mat = <meshLambertMaterial color={COLORS.lavender} transparent opacity={opacity * 0.85} />
    ...
    <group>
      ...
      {buildPct > 20 && (
        <>
          <mesh position={[-45, 12, 0]} rotation={[0, Math.PI / 2, 0]}>
            ...
            <meshLambertMaterial color={COLORS.lavender} transparent opacity={opacity * 0.7} />
          </mesh>
          {/* Rails */}
          {[-15, -5, 5, 15].map((z, i) => (
      ...
      {buildPct > 25 && [7, 14, 21].map((h, i) => (
        <mesh key={`plat-${i}`} position={[20 - i * 12, h, -25]}>
          ...
          <meshLambertMaterial color={COLORS.woodLt} transparent opacity={opacity * 0.8} />
        </mesh>
      ))}
    </group>
  )
        ...
        return (
          <group key={i} position={[Math.cos(angle) * r, 0, Math.sin(angle) * r]}>
            <mesh position={[0, 0.6, 0]}>
              ...
              <meshLambertMaterial color={COLORS.gold} transparent opacity={opacity * 0.85} />
            </mesh>
            <mesh position={[0, 0.15, 0]}>
              <cylinderGeometry args={[1.5, 1.5, 0.3, 8]} />
              <meshLambertMaterial color={COLORS.rose} transparent opacity={opacity * 0.7} />
            </mesh>
          </group>
        )
      })}
      ...
      {buildPct > 8 && Array.from({ length: 7 }, (_, i) => {
        ...
        return (
          <mesh key={`cush-${i}`} position={[Math.cos(angle) * 8, 0.2, Math.sin(angle) * 8]}>
            ...
            <meshLambertMaterial color={COLORS.gold} transparent opacity={opacity * 0.55} />
          </mesh>
        )
      })}
    </group>
  ...
  return (
    <group>
      ...
      <mesh position={[0, 2.8, -10]}>
        ...
        <meshLambertMaterial color={0x2a2030} transparent opacity={opacity * 0.8} />
      </mesh>
      {/* Desk legs */}
      {[[-8, 0], [8, 0], [-8, -5], [8, -5]].map(([x, z], i) => (
        <mesh key={i} position={[x, 1.3, -10 + z * 0.5]}>
          <cylinderGeometry args={[0.1, 0.1, 2.6, 6]} />
          <meshLambertMaterial color={COLORS.steel} transparent opacity={opacity * 0.8} />
        </mesh>
      ))}
      {/* Monitor screens */}
      {[-5, 0, 5].map((x, i) => (
        <mesh key={`mon-${i}`} position={[x, 5, -12]}>
          ...
          <meshLambertMaterial color={0x1a1520} emissive={COLORS.sky} emissiveIntensity={0.25} transparent opacity={opacity * 0.8} />
        </mesh>
      ))}
      {/* Speaker towers */}
      {[-12, 12].map((x, i) => (
        <mesh key={`spk-${i}`} position={[x, 3.5, -12]}>
          ...
          <meshLambertMaterial color={0x1a1015} transparent opacity={opacity * 0.7} />
        </mesh>
      ))}
      {/* Beat pad grid (4x4) */}
  ...
  return (
    <group>
      ...
      <mesh position={[0, 1.4, 0]}>
        ...
        <meshLambertMaterial color={COLORS.woodDk} transparent opacity={opacity * 0.8} side={THREE.DoubleSide} />
      </mesh>
      {/* Counter top */}
      <mesh position={[0, 2.8, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        <ringGeometry args={[9.5, 10.5, 20, 1, 0, Math.PI]} />
        <meshLambertMaterial color={COLORS.copper} transparent opacity={opacity * 0.8} side={THREE.DoubleSide} />
      </mesh>
      {/* Directory screen */}
      {buildPct > 50 && (
        <mesh position={[0, 6, -7]}>
          <boxGeometry args={[10, 6, 0.3]} />
          <meshLambertMaterial color={0x1a1520} emissive={COLORS.sage} emissiveIntensity={0.3} transparent opacity={opacity * 0.8} />
        </mesh>
      )}
    </group>
  )
    ...
    <group>
      ...
      {[0, 1, 2, 3, 4, 5].map((row) => (
        <mesh key={row} position={[0, row * 2 + 1, 12 + row * 5]}>
          ...
          <meshLambertMaterial color={COLORS.woodLt} transparent opacity={opacity * 0.85} />
        </mesh>
      ))}
      {/* Stage platform */}
      <mesh position={[0, 0.6, -12]}>
        <boxGeometry args={[35, 1.2, 14]} />
        <meshLambertMaterial color={COLORS.woodDk} transparent opacity={opacity * 0.7} />
      </mesh>
    </group>
  )
}
  ...
  return (
    <group>
        ...
        return (
          <group key={`desk-${i}`} position={[-20 + col * 10, 0, -10 + row * 12]}>
            ...
            <mesh position={[0, 1.8, 0]}>
              ...
              <meshLambertMaterial color={COLORS.woodLt} transparent opacity={opacity * 0.7} />
            </mesh>
            {/* Chair */}
            <mesh position={[0, 1, 1.5]}>
              <boxGeometry args={[1.5, 0.15, 1.5]} />
              <meshLambertMaterial color={COLORS.steel} transparent opacity={opacity * 0.85} />
            </mesh>
          </group>
        )
      })}
      ...
      <mesh position={[0, 5, -18]}>
        ...
        <meshLambertMaterial color={0xf0f0f0} emissive={COLORS.sky} emissiveIntensity={0.15} transparent opacity={opacity * 0.8} />
      </mesh>
      ...
      {buildPct > 2 && Array.from({ length: 6 }, (_, i) => (
        <group key={`pc-${i}`} position={[-25 + i * 10, 0, 20]}>
          <mesh position={[0, 1.8, 0]}>
            ...
            <meshLambertMaterial color={0x2a2030} transparent opacity={opacity * 0.7} />
          </mesh>
          {/* Monitor */}
          <mesh position={[0, 3, -0.5]}>
            <boxGeometry args={[2, 1.5, 0.1]} />
            <meshLambertMaterial color={0x1a1520} emissive={COLORS.sage} emissiveIntensity={0.25} transparent opacity={opacity * 0.7} />
          </mesh>
        </group>
      ))}
      ...
      <mesh position={[30, 4, 0]}>
        ...
        <meshLambertMaterial color={0x1a1520} emissive={COLORS.gold} emissiveIntensity={0.25} transparent opacity={opacity * 0.8} />
      </mesh>
    </group>
  )
}
  ...
  return (
    <group>
      ...
      <mesh position={[0, 5, -14]} rotation={[0, 0, 0]}>
        ...
        <meshLambertMaterial color={0xf0f0f0} transparent opacity={opacity * 0.8} side={THREE.DoubleSide} />
      </mesh>
      ...
      {[[-8, 5], [8, 5], [0, -8]].map(([x, z], i) => (
        <group key={i} position={[x, 0, z]}>
          ...
          <mesh position={[0, 3, 0]}>
            ...
            <meshLambertMaterial color={COLORS.steel} transparent opacity={opacity * 0.7} />
          </mesh>
          {/* Light head */}
          ...
          <mesh position={[0, 5.5, 0.5]}>
            ...
            <meshLambertMaterial color={0xf0f0f0} transparent opacity={opacity * 0.7} />
          </mesh>
        </group>
      ))}
      ...
      <mesh position={[12, 2.8, 4.5]}>
        ...
        <meshLambertMaterial color={0x1a1520} emissive={COLORS.sky} emissiveIntensity={0.2} transparent opacity={opacity * 0.7} />
      </mesh>
    </group>
  )
}
  ...
  return (
    <group>
      ...
      <mesh position={[0, 4, -14]}>
        ...
        <meshLambertMaterial color={0x00b140} transparent opacity={opacity * 0.8} />
      </mesh>
      ...
      <group position={[0, 0, 5]}>
        ...
        <mesh position={[0, 4.8, 0]}>
          ...
          <meshLambertMaterial color={0x1a1015} transparent opacity={opacity * 0.8} />
        </mesh>
      </group>
        ...
        <group key={i} position={[x, 0, 12]}>
          ...
          {[-0.9, 0.9].map((dx, j) => (
            <mesh key={j} position={[dx, 2.8, -0.5]}>
              ...
              <meshLambertMaterial color={0x1a1520} emissive={COLORS.rose} emissiveIntensity={0.15} transparent opacity={opacity * 0.7} />
            </mesh>
          ))}
        </group>
      ))}
      ...
      {buildPct > 3 && (
        <mesh position={[0, 3.5, 3]} rotation={[0.3, 0, 0]}>
          ...
          <meshLambertMaterial color={0x1a1520} emissive={COLORS.gold} emissiveIntensity={0.15} transparent opacity={opacity * 0.85} />
        </mesh>
      )}
    </group>
  )
    ...
    <group>
      ...
      <group position={[-20, 0, -15]}>
        <mesh position={[0, 3, 0]}>
          ...
          <meshLambertMaterial color={COLORS.woodDk} transparent opacity={opacity * 0.7} side={THREE.DoubleSide} />
        </mesh>
      ...
      {[0, 8, 16].map((x, i) => (
        <group key={i} position={[x, 0, 10]}>
          <mesh position={[0, 0.8, 0]}>
            ...
            <meshLambertMaterial color={COLORS.steel} transparent opacity={opacity * 0.7} side={THREE.DoubleSide} />
          </mesh>
          {/* Water surface */}
          <mesh position={[0, 1.4, 0]} rotation={[-Math.PI / 2, 0, 0]}>
            <circleGeometry args={[2.8, 12]} />
            <meshLambertMaterial color={COLORS.sky} transparent opacity={opacity * 0.8} />
          </mesh>
        </group>
      ))}
      ...
      <mesh position={[25, 3, -15]}>
        ...
        <meshLambertMaterial color={COLORS.steel} transparent opacity={opacity * 0.55} side={THREE.DoubleSide} />
      </mesh>
    </group>
  )
}
    ...
    <group>
      ...
      {[-12, -4, 4, 12].map((x, i) => (
        <group key={i} position={[x, 0, 0]}>
          <mesh position={[0, 1.2, 0]}>
            ...
            <meshLambertMaterial color={COLORS.cream} transparent opacity={opacity * 0.7} />
          </mesh>
          {/* Legs */}
          ...
          <mesh position={[0, 1.4, -3.2]}>
            ...
            <meshLambertMaterial color={COLORS.cream} transparent opacity={opacity * 0.85} />
          </mesh>
        </group>
      ))}
      ...
      {buildPct > 3 && (
        <mesh position={[0, 2.5, -15]}>
          ...
          <meshLambertMaterial color={COLORS.sky} transparent opacity={opacity * 0.7} />
        </mesh>
      )}
    </group>
  )
  ...
  return (
    <group>
      ...
      <mesh position={[0, 2.85, -20]}>
        ...
        <meshLambertMaterial color={COLORS.copper} transparent opacity={opacity * 0.7} />
      </mesh>
        ...
        <group key={i} position={[x, 0, z]}>
          ...
          {[0, 2.1, 4.2].map((angle, j) => (
            <mesh key={j} position={[Math.cos(angle) * 2.8, 0.8, Math.sin(angle) * 2.8]}>
              ...
              <meshLambertMaterial color={COLORS.sage} transparent opacity={opacity * 0.8} />
            </mesh>
          ))}
        </group>
      ))}
      ...
      <mesh position={[0, 5, -21.5]}>
        ...
        <meshLambertMaterial color={0x1a1520} emissive={COLORS.gold} emissiveIntensity={0.2} transparent opacity={opacity * 0.7} />
      </mesh>
    </group>
  )
}
  ...
  return (
    <group>
      ...
      <mesh position={[-15, 4, 0]} rotation={[0, Math.PI / 2, 0]}>
        ...
        <meshLambertMaterial color={0xffffff} transparent opacity={opacity * 0.7} />
      </mesh>
      ...
      {buildPct > 5 && [-5, 5].map((x, i) => (
        <mesh key={i} position={[x, 5, 0]}>
          ...
          <meshLambertMaterial color={COLORS.rose} transparent opacity={opacity * 0.85} />
        </mesh>
      ))}
    </group>
  )
